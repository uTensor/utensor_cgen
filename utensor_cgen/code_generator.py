...
class CodeGenerator(object):
  ...
  def generate(self, src_fname):
    ...
    weight_snippet = ContextWeightHeaderSnippet(guard_name)
    ...
    for op_id, (op_name, op_info, ref_counts, to_eval) in enumerate(construct_order, 1):
      ...
      if op_type == "Placeholder":
        ...
        weight_snippet.addvar(out_tname, out_dtype, tensor_shape, value)
    ...
    weight_fname = "test.h"
    print("Generate weight file: {}".format(weight_fname))
    with open(weight_fname, "w") as wf:
      wf.write('// Auto generated by utensor-cli\n\n')
      wf.write(weight_snippet.render())
