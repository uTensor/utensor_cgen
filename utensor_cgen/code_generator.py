...
class CodeGenerator(object):
  ...
  def generate(self, src_fname):
    ...
    weight_snippet = ContextWeightHeaderSnippet()
    composer = Composer()
    ...
    for op_id, (op_name, op_info, ref_counts, to_eval) in enumerate(construct_order, 1):
      ...
      if op_type == "Placeholder":
        ...
        weight_snippet.addvar(inline_tname, out_dtype, tensor_shape, value)
    ...
    print("Generate weight file: {}".format(weightheader_fname))
