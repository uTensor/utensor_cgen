...
SNIPPET_CONFIG = {
  ...
  "snippets/min_op.cpp": set(['"MathOps.hpp"']),
  "snippets/max_op.cpp": set(['"MathOps.hpp"']),
  "snippets/argmax_op.cpp": set(['"MathOps.hpp"']),
  "snippets/dequantize_op.cpp": set(['"ArrayOps.hpp"']),
  "snippets/qmatmul_op.cpp": set(['"MatrixOps.hpp"']),
  "snippets/quantV2_op.cpp": set(['"ArrayOps.hpp"']),
  "snippets/qrelu_op.cpp": set(['"NnOps.hpp"']),
  "snippets/reshape_op.cpp": set(['"ArrayOps.hpp"']),
